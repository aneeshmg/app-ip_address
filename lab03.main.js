 ...
 * @return {object} (firstIpAddress in ipv4 and ipv6) - An object contaning IPv4 and IPv6 addresses.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  return callback({ipv4: firstIpAddress, ipv6: firstIpv6Address}, callbackError);
}
